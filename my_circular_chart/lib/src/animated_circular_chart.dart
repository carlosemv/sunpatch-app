...
import 'package:circular_chart/src/entry.dart';
import 'package:circular_chart/src/painter.dart';
...
class AnimatedCircularChart extends StatefulWidget {
  ...
  final List<TextPainter> holeTextPainters;
...
class AnimatedCircularChartState extends State<AnimatedCircularChart>
  ...
  void didChangeDependencies() {
    ...
    if (widget.holeTextPainters != null) {
      for (var p in widget.holeTextPainters) {
        p.textDirection = Directionality.of(context);
        p.textScaleFactor = MediaQuery.of(context).textScaleFactor;
      }
    }
  }
