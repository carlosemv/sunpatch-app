[![pub package](https://img.shields.io/pub/v/circular_chart.svg)](https://pub.dartlang.org/packages/circular_chart)
...
Install the latest version [from pub](https://pub.dartlang.org/packages/circular_chart#-installing-tab-).
